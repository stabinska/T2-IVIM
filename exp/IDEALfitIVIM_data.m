function [FitResults,FitQuality,Params,ROIstat] = IDEALfitIVIM_data(Data_raw, Mask, path_Data, Params,path_Mask,path_ROI)
...
%     for slice = Params.slice
    for slice = 1
                            ...
                            switch Params.Model
                                ...
                                case {"biexp_T1corr","Biexp_T1corr"}
                                    [FitResults{x,y}, gof{x,y}, ...
                                        ...
                                        squeeze(Data_res(x,y,:))', op, Params.TM);
                                case {"biexp_T1andT2corr","Biexp_T1andT2corr"}
                                     [FitResults{x,y}, gof{x,y}, ...
                                        output{x,y}] = ...
                                        BiexpFit_T1andT2corr(Params.b_values, ...
                                        squeeze(Data_res(x,y,:))', op, Params.TM, Params.TE);
                                case {"biexp_biT1andT2corr","Biexp_biT1andT2corr"}
                                     [FitResults{x,y}, gof{x,y}, ...
                                        output{x,y}] = ...
                                        BiexpFit_biT1andT2corr(Params.b_values, ...
                                        squeeze(Data_res(x,y,:))', op, Params.TM, Params.TE);
                                case {"triexp","Triexp"}
                                    [FitResults{x,y}, gof{x,y}, ...
                                        output{x,y}] = ...
                                ...
                                case {"S0fit"}  
                                    [FitResults{x,y}, gof{x, y}, ...
                                        output{x, y}] = ...
                                        S0Fit_T1corr(Params.b_values, squeeze(Data_res(x,y, :))', op);
        ...
        % Create struct with data, mask and ROIs
